...
<style>
    ...
    /* --- NEW CSS FOR REVIEW CARD LAYOUT --- */
    .review-card {
...
<form id="page-container" name="form1" method="post" action="">
    ...
    <div class="settings-menu-container">
        <button type="button" id="settings-btn" class="settings-button">
        ...
        <div class="main-column">
            ...
            <section class="content-section" id="reviews-section">
                ...
                <div class="average-rating-display">
                    ...
                    $total_review = 0;
                    $total_user_rating = 0;
                    $query = "SELECT * FROM tbl_rating where lab_id = '".$_SESSION['lid']."'";
                    ...
                    for ($i = 1; $i <= 5; $i++) {
                        if ($i <= round($average_rating)) {
                            ...
                            echo '<i class="far fa-star"></i>'; // Use 'far' for empty
                        }
                    }
                    ?>
                    </span>
                ...
                <div class="review-list">
                    <?php
                    $review_query = "SELECT * FROM tbl_rating t INNER JOIN tbl_user u ON t.user_id=u.user_id WHERE lab_id = '".$_SESSION['lid']."' ORDER BY rating_id DESC";
                        ...
                        <div class="review-main">
                            <div class="review-header">
                                ...
                                <span class="review-stars">
                                    <?php
                                    for($i = 1; $i <= 5; $i++) {
                                        if($i <= $review_row['rating_data']) { // Corrected from rating_data
                                            echo '<i class="fas fa-star"></i>'; // Filled
                                        } else {
                                            echo '<i class="far fa-star"></i>'; // Border
                                        }
                                    }
                                    ?>
                                </span>

      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          ...
          <div class="footer-contact pt-3">
            ...
            <p><strong>Email:</strong> <a href="https://mail.google.com/mail/?view=cm&fs=1&to=labfinder@gmail.com" target="_blank" style="color: #2a2a2ac6">labfinder@gmail.com</a></p>
          </div>
          <br>
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><a href="HomePageL.php#about">About us</a></li>
          </ul>
        </div>
